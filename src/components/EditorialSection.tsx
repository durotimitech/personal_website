...
const articles = [
    ...
    },
    {
        ...
        date: 'January 7, 2025',
        readTime: '4 min read',
        title: 'The Art of Building Beautiful, Purposeful Digital Brand Experiences',
        tag: 'Artificial intelligent',
    },
];
                        ...
                        {articles.map((article, i) => (
                            <div key={i} className="flex flex-col">
                                ...
                                <div className="flex items-center justify-between mt-auto pt-2">
                                    <span className="text-xs text-neutral-500">{article.tag}</span>
                                    <button className={`flex items-center gap-1 px-4 py-1.5 rounded-full font-medium text-xs shadow border transition ${i === 1 ? 'bg-[#00FF57] text-white border-[#00FF57]' : 'bg-white text-black border-neutral-200 hover:bg-neutral-50'}`}>
                                        Read All
