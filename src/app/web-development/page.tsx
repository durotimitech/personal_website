...
export default function WebDevelopmentPage() {
    return (
        <main className=" w-full bg-white py-16 px-4 md:px-10">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-8 text-neutral-900 text-center">Web Development</h1>
...
function ProjectCard({ number, title, image, link, large }: Project) {
        ...
        >
            ...
            <div className="flex flex-col gap-1 px-4 py-4 bg-white rounded-b-2xl border-t border-neutral-200 mt-0">
                <div className="flex items-center gap-2">
                    <span className="text-xs text-neutral-400 font-mono font-bold">{number}</span>
                    <span className="text-xs text-neutral-400 font-mono font-bold">{title}</span>
                </div>
            </div>
        </motion.div>
    );
